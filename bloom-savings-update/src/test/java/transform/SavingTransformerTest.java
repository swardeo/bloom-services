...
class SavingTransformerTest {
    ...
    @Test
    void mapContainsAdjustmentsAttributesWhenInvoked() {
        // given
    ...
    @Test
    void mapContainsOneTimePaymentsAttributesWhenInvoked() {
        // given
    ...
    void keyMapConstructsCorrectlyWhenInvoked() {
        ...
        // when
        Map<String, AttributeValue> actual = sut.toKey(savingName, mockCognitoIdentity);
